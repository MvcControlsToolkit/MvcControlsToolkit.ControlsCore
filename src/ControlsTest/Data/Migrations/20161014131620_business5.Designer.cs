...
namespace ControlsTest.Data.Migrations
{
    ...
    [Migration("20161014131620_business5")]
    partial class business5
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ControlsTest.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ControlsTest.Models.ProductWithMaintenance", b =>
                {
                    b.HasOne("ControlsTest.Models.Product", "Base")
                        .WithOne("Maintenance")
                        .HasForeignKey("ControlsTest.Models.ProductWithMaintenance", "ProductId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ControlsTest.Models.ApplicationUser")
                        .WithMany("Claims")
